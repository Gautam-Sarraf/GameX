...
export default function HomePage() {
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    e.preventDefault();
    if (!email) return;
    toast.success('Successfully subscribed to the EsportBrawl Newsletter!');
    setEmail('');
  };
  ...
  return (
    <div className="relative min-h-screen bg-[#030303] overflow-x-hidden">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 z-10">
          ...
          <motion.p
            ...
            className="max-w-2xl mx-auto text-zinc-350 text-base md:text-lg font-medium"
          >
          ...
          >
            ...
            <Link href="/create-tournament">
              <Button size="lg" variant="outline" className="min-w-[180px] font-black uppercase text-sm border-zinc-850 hover:border-zinc-700 bg-zinc-950/80 hover:bg-zinc-900">
                Create Tournament
              </Button>
            </Link>
          </motion.div>
      ...
      >
        ...
        <section className="py-10 bg-black/85 border-b border-zinc-900/80 backdrop-blur-sm">
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-900 bg-black/60 rounded-xl my-6 backdrop-blur-xs">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">High-stakes matches ready for signups right now.</p>
            </div>
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-900 bg-black/60 rounded-xl my-6 backdrop-blur-xs">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-zinc-400 text-sm mt-1">Ready to compete in your favorite titles.</p>
          </div>
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-900 bg-black/60 rounded-xl my-6 backdrop-blur-xs grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">Verified leagues running weekly cups.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {topOrganizers.map((org) => (
                <Card key={org.id} className="border-zinc-900 bg-zinc-950/40 p-4 flex items-center gap-4 hover:border-zinc-800 transition-colors">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-zinc-400 text-sm mt-1">Top players by global leaderboard rank.</p>
            </div>
            <div className="space-y-3 bg-zinc-950/45 border border-zinc-900 p-4 rounded-xl">
              {topPlayers.map((player, idx) => (
                <div key={player.id} className="flex items-center justify-between py-2 border-b border-zinc-900 last:border-0">
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-zinc-900 bg-black/60 rounded-xl my-6 backdrop-blur-xs">
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-black uppercase tracking-tight text-white font-oswald flex items-center justify-center md:justify-start gap-2">
              <ShoppingBag className="h-6 w-6 text-orange-500" /> EsportBrawl Merch
            </h2>
            <p className="text-zinc-400 text-sm mt-1">High quality accessories designed for tactical gamers.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {gears.map((item) => (
              <Card 
                key={item.id} 
                className="overflow-hidden border-zinc-900 bg-zinc-950/45 hover:border-zinc-800 transition-colors bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: 'url("/assets/images/gears-card-bg.png")' }}
              >
                <div className="h-44 w-full bg-black/40 p-6 flex items-center justify-center border-b border-zinc-900">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={item.img} alt={item.name} className="h-36 object-contain" />
                </div>
                <CardContent className="p-5 space-y-3 bg-black/60">
                  <div>
        ...
        <section 
          className="relative py-16 bg-zinc-950/80 border-b border-zinc-900 bg-center bg-cover bg-no-repeat overflow-hidden rounded-xl my-6"
          style={{ backgroundImage: 'url("/assets/images/newsletter-bg.jpg")' }}
        >
          <div className="absolute inset-0 bg-black/80 z-0" />
          <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 space-y-6 z-10">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 z-10">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[11px] leading-relaxed">
              EsportBrawl is a client-side mock demo. All matches, profiles, and wallet tokens are simulation models.
            </p>
          </div>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-zinc-900/60 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] z-10">
          <p>© 2026 EsportBrawl. Built by code specialists.</p>
